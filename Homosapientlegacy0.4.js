G.AddData({
	...
	//materialRes
		...
		new G.Policy({
			...
			desc: 'Improves [gatherer], [hunter] and [fisher] efficiency by 20% and lowers their influence on [resource depletetion by a fair amount]. Consumes 5 [influence] every 20 days; will stop if you run out.',
			icon: [4, 12, 4, 7],
			cost: { 'influence': 3 },
			startMode: 'off',
			req: { 'clans': true },
