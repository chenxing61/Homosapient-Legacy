G.AddData({
	...
	func: function () {
		...
		*/
		...
		new G.Res({
			name: 'productivity',
			desc: '[productivity] describes the extra/lessened effeciciency your [worker]s are working at, which is what stats like [happiness] and [health], the amount of [infrastructure]s affects.',
			visible: true,
			icon: [14, 3, 'H1sheet'],
			fractional: true,
			getDisplayAmount: function () {
